...
[`@aws-sdk/client-iotsitewise`](https://www.npmjs.com/package/@aws-sdk/client-iotsitewise/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S6/xSPLsbmm68VoLfPfTXkpMPUrFfG4Is8fGSe0Ous2Oze4ShuH7Nx591Ho/xLG1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotsitewise": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.196.0/index.min.mjs": "sha384-S6/xSPLsbmm68VoLfPfTXkpMPUrFfG4Is8fGSe0Ous2Oze4ShuH7Nx591Ho/xLG1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotsitewise/blob/refs/tags/3.196.0/LICENSE
```
