...
[`@aws-sdk/client-iotsitewise`](https://www.npmjs.com/package/@aws-sdk/client-iotsitewise/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BHh6GPvPuQHheWNEQ0Ymaaq0NlPtBFCSt8sIP84ktmqLtodnSoptsCcHwa/i+8u7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotsitewise": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsitewise@3.975.0/index.min.mjs": "sha384-BHh6GPvPuQHheWNEQ0Ymaaq0NlPtBFCSt8sIP84ktmqLtodnSoptsCcHwa/i+8u7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotsitewise/blob/refs/tags/3.975.0/LICENSE
```
